  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        <span className="italic">Informática de Sistemas</span> e venho me dedicando a aprender e aplicar meus conhecimentos em projetos práticos, com foco em desenvolvimento <span className="underline">full stack</span>. 
